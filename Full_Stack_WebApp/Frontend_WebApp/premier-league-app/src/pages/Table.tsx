          ...
          <thead>
            <tr>
              ...
              <th className="team-col" onClick={() => sortTable('team_name')}>
                Team {sortBy === 'team_name' && (sortOrder === 'desc' ? '↓' : '↑')}
              </th>
              <th onClick={() => sortTable('matches_played')} className="sortable">
                P {sortBy === 'matches_played' && (sortOrder === 'desc' ? '↓' : '↑')}
              </th>
              ...
              <th onClick={() => sortTable('goals_for')} className="sortable">
                GF {sortBy === 'goals_for' && (sortOrder === 'desc' ? '↓' : '↑')}
              </th>
              <th onClick={() => sortTable('goals_against')} className="sortable">
                GA {sortBy === 'goals_against' && (sortOrder === 'desc' ? '↓' : '↑')}
              </th>
              <th onClick={() => sortTable('goal_difference')} className="sortable">
                GD {sortBy === 'goal_difference' && (sortOrder === 'desc' ? '↓' : '↑')}
              </th>
              <th onClick={() => sortTable('points')} className="sortable points-col">
            ...
            {leagueTable.map((teamData, index) => (
              ...
              >
                ...
                <td className="team-cell">
                  <span className="team-logo">{getTeamLogo(teamData.team.name)}</span>
                ...
                <td className={teamData.goal_difference >= 0 ? 'positive' : 'negative'}>
                  {teamData.goal_difference >= 0 ? '+' : ''}{teamData.goal_difference}
                </td>
